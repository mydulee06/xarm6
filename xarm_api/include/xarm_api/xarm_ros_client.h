...
public:
	...
	// SetInt16Str
	int xarm_record(int data, const std::string& parameter = "");
...
private:
	...
	//SetInt16Str
	std::shared_ptr<xarm_msgs::srv::SetInt16Str::Request>  req_set_int16_str_;
	rclcpp::Client<xarm_msgs::srv::SetInt16Str>::SharedPtr client_xarm_record_;
