...
{   
    ...
    req_set_int16_str_ = std::make_shared<xarm_msgs::srv::SetInt16Str::Request>();
    ...
    client_xarm_record_ = _create_client<xarm_msgs::srv::SetInt16Str>("xarm_record");
...
//SetInt16Str
int XArmROSClient::xarm_record(int data, const std::string& parameter){
    req_set_int16_str_->data = data;
    req_set_int16_str_->parameter = parameter;
    return _call_request(client_xarm_record_, req_set_int16_str_);
}
